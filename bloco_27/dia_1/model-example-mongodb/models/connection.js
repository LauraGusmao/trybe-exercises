...
// Armazenamos as configurações de conexão em uma constante para facilitar a leitura do código.
const OPTIONS = {
...
const connection = () => {
  // Usamos um ternário para verificar se já temos uma conexão e decidir o que retornar.
  return db
